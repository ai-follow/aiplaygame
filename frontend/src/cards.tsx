...
function JokerFaceSvg({ rank }: { rank: string }) {
  const big = rank === 'RJ';
  const ink = big ? '#d82835' : '#17120d';
  const label = big ? '大王' : '小王';
  return (
    <>
      <text x="9" y="18" fill={ink} fontSize="12" fontWeight="900" fontFamily="Arial, sans-serif">
        {big ? '大' : '小'}
      </text>
      <text x="10" y="31" fill={ink} fontSize="12" fontWeight="900" fontFamily="Arial, sans-serif">
        王
      </text>
      <path
        d="M32 20c7 7 13 15 13 25 0 11-6 19-13 25-7-6-13-14-13-25 0-10 6-18 13-25Z"
        fill={big ? 'rgba(216,40,53,0.12)' : 'rgba(23,18,13,0.08)'}
        stroke={ink}
        strokeWidth="1.4"
      />
      <text
      ...
      <g transform="rotate(180 54 74)">
        <text x="54" y="74" textAnchor="middle" fill={ink} fontSize="12" fontWeight="900" fontFamily="Arial, sans-serif">
          {big ? '大' : '小'}
        </text>
        <text x="54" y="87" textAnchor="middle" fill={ink} fontSize="12" fontWeight="900" fontFamily="Arial, sans-serif">
          王
        </text>
      </g>
    </>
